...
void diablo_tapdance_master(tap_dance_state_t *state, void *user_data) {
    diablo_keys_t *diablo_keys = (diablo_keys_t *)user_data;
...
#define ACTION_TAP_DANCE_DIABLO(index, keycode) {  \
    ...
    .user_data = (void *)&((diablo_keys_t) { index, keycode }),  \
  }
// clang-format on
...
tap_dance_action_t tap_dance_actions[] = {
    ...
    [TD_D4_1] = ACTION_TAP_DANCE_DIABLO(0, KC_1),
    [TD_D4_2] = ACTION_TAP_DANCE_DIABLO(1, KC_2),
    [TD_D4_3] = ACTION_TAP_DANCE_DIABLO(2, KC_3),
    [TD_D4_4] = ACTION_TAP_DANCE_DIABLO(3, KC_4),
